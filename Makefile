...
all: f_udunits_2.f90 check_status.f90 write_littler.f90 readncdf.f90 logging.f90 convert_littler.f90
	...
	$(FC) $(FFLAGS) -o $(main) convert_littler.f90 f_udunits_2.f90 check_status.f90 readncdf.f90 write_littler.f90 logging.f90 -L/usr/lib -I/usr/include -lnetcdf -lnetcdff -Wimplicit-interface -ludunits2 -ffree-form
