...
gfortran -c write_littler.f90
gfortran -c readncdf.f90 check_status.f90  -L/usr/lib -I/usr/include -lnetcdf -lnetcdff
gfortran -o test convert_littler.f90 f_udunits_2.f90 check_status.f90 readncdf.f90 write_littler.f90 -L/usr/lib -I/usr/include -lnetcdf -lnetcdff -Wimplicit-interface -ludunits -ffree-form
